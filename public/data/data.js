...
export const examples = {
  insert: {
    ...
    python_example:
      wrapPythonExample(`cursor.execute("INSERT INTO users (id, name) VALUES (?, ?)", (3, "John"))
con.commit()`),
  },
  ...
  select: {
    ...
    python_example:
      wrapPythonExample(`cursor.execute("SELECT * FROM users WHERE id = ?",(1,))
rows = cursor.fetchall()`),
  ...
  update: {
    ...
    python_example:
      wrapPythonExample(`cursor.execute("UPDATE users SET name = ? WHERE id = ?", ("May", 2))
con.commit()`),
  },
  ...
  delete: {
    ...
    python_example:
      wrapPythonExample(`cursor.execute("DELETE FROM users WHERE id = ?", (1,))
con.commit()`),
  },
};

export const tablesCreation = {
